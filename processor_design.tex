...
\def\imagetop#1{\vtop{\null\hbox{#1}}}
	...
	\begin{tabular}{ll}
	a) & b) \\
	\imagetop{\includegraphics[width=0.6\textwidth]{./material/mathematica/qubit_qubit_swap_error}} &
	\imagetop{\includegraphics[width=0.4\textwidth]{./material/figures/2-qubit-processor/flux_pulse_rise_time}}
	\end{tabular}
