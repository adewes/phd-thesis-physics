...
if ((error==0)&& expose5!=0){Quantro_Expose(structure,listOfLayer5,mag,dose5,relDoseMin5,dwellTimeMin,probeCurrent,showCalculate,showTime)};
if ((error==0)&& expose11!=0){Quantro_Expose(structure,listOfLayer11,mag,dose11,relDoseMin11,dwellTimeMin,probeCurrent,showCalculate,showTime)};
if ((error==0)&& expose9!=0){Quantro_Expose(structure,listOfLayer9,mag,dose9,relDoseMin9,dwellTimeMin,probeCurrent,showCalculate,showTime)};
