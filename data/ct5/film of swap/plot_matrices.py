...
spinMatrix = Datacube("fitted density matrices")
spinMatrix.loadtxt("State Tomography of Swap vs Swap Duration_Quantum Process Tomography at time 26-0_0_Swap of state 0_0_180_0-0_0_Measured spins-300_0")
...
for i in range(0,len(spinMatrix)):
	...
	clf()
	plotDensityMatricesContour([resultMatrix],showOutline = [False],annotate = False,labels=[])
