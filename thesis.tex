...
\title{\normalsize These de Doctorat de l'Université Pierre et Marie Curie \\ \huge Demonstrating Quantum Speed-Up with a Two-Transmon Quantum Processor \\ \normalsize Specialité: Physique Quantique}
...
\date{\vspace{2cm} Thèse préparee au sein du Service de Physique de l'Etat Condensé, CEA Saclay}
...
\input{processor_design}

\input{measurement_techniques}

\input{processor_characterization}
